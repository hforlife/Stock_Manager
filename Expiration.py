...
class Expiration:
    def __init__(self, root):
        ...
        gestion_title = tk.Label(self.root, text="ALERTE D'EXPIRATION", font=("Poppins", 25, "bold"), bg="lightgray", fg="#343A40")
    ...
    def remplir_tableau_resultats(self):
        ...
        try:
            ...
            for row in resultats:
                nomproduit, quantiter, expiration = row
                date1 = datetime.datetime.strptime(expiration, "%Y-%m-%d").date()
