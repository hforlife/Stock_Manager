...
# screen Title
        title = Label(self.root, text="Tableau de Bord", font=("Poppins", 26, "bold"), bg="white", fg="#343A40",anchor="w", padx=20)  # may add anchor here to center left
        title.place(x=270, y=0, relwidth=1, height=70)
# logout button
        logout_btn = Button(self.root, text="Déconnexion", command=self.logout, font=("Poppins", 11, "bold"), bd=0,bg="#F66B0E", fg="white")
        logout_btn.place(x=1180, y=10, height=40, width=120)
# Menu
        menu_frame = Frame(self.root, bd=0, bg="#23282c", relief=RIDGE)
        menu_frame.place(x=0, y=0, width=280, height=400, relheight=1)
        menu_label = Label(menu_frame, text="Menu", font=("Poppins", 15, "bold"))
        ...
        alerte_btn.pack(side=TOP, anchor="c")
        employee_btn = Button(menu_frame, text="Employée", command=self.employee, font=("Lato", 18, "normal"),bg="#23282c", fg="#a7acb2", bd=0, cursor="hand2")
        employee_btn.pack(side=TOP ,anchor="c")
        ...
        category_btn.pack(side=TOP, anchor="c")
        ...
        expiration_btn.pack(side=TOP, anchor="c")
        ...
        product_btn.pack(side=TOP, anchor="c")
        ...
        supplier_btn.pack(side=TOP, anchor="c")
...
# dashboard content
        ...
        title = Label(self.root, text="Ventes  Recentes", font=("Lato", 26, "bold"), bg="white", fg="#343A40",anchor="w", padx=20)  # may add anchor here to center left
...
################################################################################################################################
        ...
        title = Label(self.root, text="Facture Recentes", font=("Lato", 26, "bold"), bg="white", fg="#343A40",anchor="w", padx=20)  # may add anchor here to center left
...
# Placer les barres de défilement dans le cadre
    ...
    def update_content(self):
        ...
        try:
            ...
            cur.execute("select COUNT(*) from listeproduit where expiration<= ?", (datelimite,))
...
# Créez une instance de la classe Tk pour la fenêtre principale
root = Tk()

# Créez une instance de la classe StockManager et passez la fenêtre principale comme argument
system = StockManager(root)

# Centrez la fenêtre principale sur l'écran en utilisant la fonction center_window
